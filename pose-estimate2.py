...
@torch.no_grad()
def run(poseweights="yolov7-w6-pose.pt",source="NMPLvideo.mkv",device='cpu',view_img=False,
    ...
    if (cap.isOpened() == False):   #check if videocapture not opened
        ...
        while(cap.isOpened): #loop until cap opened or video not complete
            ...
            if ret: #if success is true, means frame exist
                ...
                print("points of each keypoints ",(output[7:]))
...
def parse_opt():
    ...
    parser.add_argument('--save-conf', action='store_true', default='True',help='save confidences in --save-txt labels') #save confidence in txt writing
